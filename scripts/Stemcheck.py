...
if selected_comments_accepted:
    ...
    if st.button(combined_button_text):
        ...
        Feedback_file= pd.read_excel(r"C:\Users\User\OneDrive - VigyanShaala\00 DBMS 1.0\Kalpana\Kalpana\Assignment Checker GUI\data_files\Feedback.xlsx")
        # If a user name is found for the entered access code, display the select box for that user
        ...
        if os.path.isfile(r"C:\Users\User\OneDrive - VigyanShaala\00 DBMS 1.0\Kalpana\Kalpana\Assignment Checker GUI\data_files\Feedback.xlsx"):
            # Read the existing Excel file
            existing_data = pd.read_excel(r"C:\Users\User\OneDrive - VigyanShaala\00 DBMS 1.0\Kalpana\Kalpana\Assignment Checker GUI\data_files\Feedback.xlsx")
            ...
            updated_data.to_excel(r"C:\Users\User\OneDrive - VigyanShaala\00 DBMS 1.0\Kalpana\Kalpana\Assignment Checker GUI\data_files\Feedback.xlsx", index=False)
        else:
            # If the Excel file does not exist, create a new file and write the feedback data
            feedback_df.to_excel(r"C:\Users\User\OneDrive - VigyanShaala\00 DBMS 1.0\Kalpana\Kalpana\Assignment Checker GUI\data_files\Feedback.xlsx", index=False)
